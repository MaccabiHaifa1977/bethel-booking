...
const DEFAULTS = {
  site_name: { en: 'Bethel Hostel Haifa', he: 'אכסניית בית אל חיפה', de: 'Bethel Hostel Haifa' },
  site_subtitle: {
  ...
  gallery: [
    { src: `${WP}/2020/06/Front-of-Hostel-Garden.jpeg`, caption: { en: 'Front of the hostel – garden', he: 'חזית האכסניה – הגינה', de: 'Vorderseite der Herberge – Garten' } },
    { src: `${WP}/2025/06/Entrance--scaled-1200x900.jpeg`, caption: { en: 'Entrance', he: 'הכניסה', de: 'Eingang' } },
    { src: `${WP}/2020/06/Dinning-Room-and-Recreational-area.jpeg`, caption: { en: 'Dining room and recreation area', he: 'חדר האוכל ואזור הפנאי', de: 'Speise- und Aufenthaltsraum' } },
    { src: `${WP}/2025/06/Porch-scaled-1200x900.jpeg`, caption: { en: 'Porch', he: 'המרפסת', de: 'Veranda' } },
    { src: `${WP}/2025/06/Gardens--scaled-1200x900.jpeg`, caption: { en: 'Garden', he: 'הגינה', de: 'Garten' } },
    { src: `${WP}/2025/06/Guest-House-Area-scaled-1200x703.jpeg`, caption: { en: 'Guest house area', he: 'אזור בית ההארחה', de: 'Gästehausbereich' } },
    { src: `${WP}/2025/06/Fellowship-shared-Rooms-scaled-1200x675.jpeg`, caption: { en: 'Fellowship room', he: 'חדר השיתוף', de: 'Gemeinschaftsraum' } },
    { src: `${WP}/2025/06/Second-floor-of-the-guest-house-scaled-1200x1600.jpeg`, caption: { en: 'Second floor of the guest house', he: 'הקומה השנייה של בית ההארחה', de: 'Obergeschoss des Gästehauses' } },
  ],
  nearby: [
    { src: `${WP}/2020/06/German-Colony-location-of-Bethel-Hostel-980x550.jpeg`, caption: { en: 'German Colony – where Bethel is', he: 'המושבה הגרמנית – כאן נמצאת בית אל', de: 'Deutsche Kolonie – hier liegt Bethel' } },
    { src: `${WP}/2020/06/Bat-Galim-Beach-Promenade-20-minute-walk-from-Hostel-980x550.png`, caption: { en: 'Bat Galim beach promenade – 20 minutes on foot', he: 'טיילת בת גלים – 20 דקות הליכה', de: 'Strandpromenade Bat Galim – 20 Minuten zu Fuß' } },
  ],
};
